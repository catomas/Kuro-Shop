...
export const ProductForm = ({
  ...
  const onSubmit = async (data: FormInputs) => {
    ...
    formData.append("principalCategoryId", productToSave.principalCategoryId);
    formData.append("secondCategoryId", productToSave.secondCategoryId ?? "");
    ...
    >
      ...
      <div className="w-full">
        ...
        <div className="flex flex-col mb-2">
          ...
          <select
            className="p-2 border rounded-md bg-gray-200"
            {...register("principalCategoryId", { required: true })}
          >
            <option value="">[Seleccione]</option>
        ...
        <div className="flex flex-col mb-2">
          ...
          <select
            className="p-2 border rounded-md bg-gray-200"
            {...register("secondCategoryId", { required: true })}
          >
            <option value="">[Seleccione]</option>
